...
import it.tezosx.octezconnect.core.internal.storage.sharedpreferences.encryptedfile.EncryptedFileManager
...
public fun SharedPreferencesSecureStorage(context: Context): SharedPreferencesSecureStorage {
    ...
    val encryptedFileManager = EncryptedFileManager(context, keyStore)
