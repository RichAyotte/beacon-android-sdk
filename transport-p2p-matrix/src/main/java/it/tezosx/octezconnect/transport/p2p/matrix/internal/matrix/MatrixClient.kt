...
import it.tezosx.octezconnect.core.internal.utils.*
...
import it.tezosx.octezconnect.transport.p2p.matrix.internal.matrix.store.*
...
internal class MatrixClient(
    ...
    fun syncPollFlow(scope: CoroutineScope, node: String, interval: Long = 0): Flow<Result<MatrixSync>> {
        val syncMutex = Mutex()
