package it.tezosx.octezconnect.transport.p2p.matrix.internal.migration.v1_0_4

import it.tezosx.octezconnect.core.internal.migration.Migration
import it.tezosx.octezconnect.core.internal.migration.VersionedMigration
...
import it.tezosx.octezconnect.transport.p2p.matrix.internal.migration.MatrixMigrationTarget
import it.tezosx.octezconnect.transport.p2p.matrix.internal.storage.getMatrixRelayServer
import it.tezosx.octezconnect.transport.p2p.matrix.internal.storage.getMatrixRooms
import it.tezosx.octezconnect.transport.p2p.matrix.internal.storage.getMatrixSyncToken
import it.tezosx.octezconnect.transport.p2p.matrix.internal.storage.setMatrixRelayServer
