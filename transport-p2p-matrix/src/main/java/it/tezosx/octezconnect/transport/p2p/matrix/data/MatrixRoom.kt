package it.tezosx.octezconnect.transport.p2p.matrix.data
...
import it.tezosx.octezconnect.transport.p2p.matrix.internal.migration.v3_2_0.MatrixRoomSerializer
